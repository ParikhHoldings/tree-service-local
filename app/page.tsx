...
export const metadata: Metadata = {
  title: 'TreeService Service Local — Find the Best Landscapers Near You',
  description: 'Compare top-rated, licensed treeService and tree service companies in 50+ US cities. Real prices on mowing, design, tree trimming, and sprinkler install. Get 3 free quotes.',
}
    ...
    <main>
      <section className="bg-gradient-to-br from-green-800 via-green-700 to-emerald-600 text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 rounded-full px-4 py-2 text-sm mb-6">
            🌿 50 cities · Licensed tree service experts · Free quotes
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-5 leading-tight">
            Find the Best TreeService Company<br className="hidden md:block" /> in Your City
          </h1>
          <p className="text-green-100 text-xl max-w-2xl mx-auto mb-8">
            Compare licensed, top-rated tree service experts. Real prices on tree trimming, yard design, tree trimming, and sprinkler installation. Free quotes, no obligation.
          </p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-2">Popular TreeService Markets</h2>
          <p className="text-gray-600 text-center mb-10">Click your city for top tree service experts, local pricing, and free quotes.</p>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: '🔍', title: 'Find Your City', desc: 'Browse 50+ cities. See top-rated local tree service experts, real pricing, and seasonal tips.' },
              { icon: '📋', title: 'Get Free Quotes', desc: 'Submit a quick request and connect with up to 3 licensed, local tree service experts within 24 hours.' },
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl font-bold text-center mb-10">TreeService Services We Help You Find</h2>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { icon: '🌱', title: 'Lawn Mowing', desc: 'Weekly, bi-weekly, or monthly mowing service. $35–$120 per visit.' },
              { icon: '🏡', title: 'TreeService Design', desc: 'Full yard design, planting, and installation. $2,000–$20,000.' },
              ...
              { icon: '🌿', title: 'Tree Service Programs', desc: 'Fertilizing, weed control, aeration, overseeding. Annual contracts save 15–20%.' },
            ].map(svc => (
      ...
      <section className="py-16 px-4 bg-green-600 text-white text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-green-100 mb-8">Top tree service experts in most cities are booked 3–6 weeks out by May. Get your quotes now.</p>
      ...
      <footer className="bg-gray-900 text-gray-400 py-10 px-4 text-center text-sm">
        <div className="max-w-5xl mx-auto">
          <div className="font-semibold text-white mb-2">TreeService Service Local</div>
          <p className="mb-4">Connecting homeowners with licensed treeService companies in 50+ US cities.</p>
          <p className="text-xs">© {new Date().getFullYear()} TreeService Service Local. Pricing data is based on regional market research and may vary.</p>
        </div>
      </footer>
    </main>
  )
